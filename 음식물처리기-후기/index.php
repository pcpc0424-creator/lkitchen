...
/**
 * 음식물처리기 후기 페이지
 * 관리자 페이지의 food_reviews.json 데이터와 연동
 */
require_once dirname(__DIR__) . '/includes/config.php';

// 후기 데이터 로드
$reviews = getReviewData('food');
...
<head>
    ...
    <title>음식물처리기 후기 | 러블리키친</title>
    <meta name="description" content="러블리키친 음식물처리기 고객 후기">
...
<body>
    ...
    <main>
        <section class="page-hero"><div class="page-hero-bg"></div><div class="page-hero-overlay"></div><div class="container"><div class="page-hero-content" data-aos="fade-up"><nav class="breadcrumb"><a href="<?php echo SITE_URL; ?>/">홈</a><span><i class="fas fa-chevron-right"></i></span><span>구매후기</span><span><i class="fas fa-chevron-right"></i></span><span class="current">음식물처리기 후기</span></nav><h1 class="page-title">음식물처리기 후기</h1><p class="page-subtitle">고객님들의 생생한 사용 후기를 확인하세요</p></div></div></section>
