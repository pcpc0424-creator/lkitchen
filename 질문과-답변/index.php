            ...
            <div class="container">
                ...
                <div class="contact-form" data-aos="fade-up">
                    <form id="inquiryForm" action="#" method="post">
                        ...
                        <div class="form-group">
                            <label for="daytime">통화가능 시간</label>
                            <select id="daytime" name="daytime" style="width: 100%; padding: 14px 16px; border: 1px solid #e0e0e0; border-radius: 8px; font-size: 1rem; color: #333; background: #fff; cursor: pointer;">
