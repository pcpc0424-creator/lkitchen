...
<body>
    ...
    <main>
        ...
        <!-- Sinkbowl Link Section -->
        <section class="sinkbowl-link-section" style="padding: 60px 0; background: linear-gradient(135deg, #0ea5e9 0%, #0284c7 100%);">
            <div class="deals-container">
                <div style="text-align: center;" data-aos="fade-up">
                    <div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(255,255,255,0.2); padding: 8px 20px; border-radius: 30px; margin-bottom: 20px;">
                        <i class="fas fa-sink" style="color: #fff;"></i>
                        <span style="color: #fff; font-weight: 600;">SINKBOWL</span>
                    </div>
                    <h2 style="font-size: clamp(1.5rem, 3vw, 2rem); font-weight: 700; color: #fff; margin-bottom: 10px;">아콴테 프리미엄 사각싱크볼</h2>
                    <p style="color: rgba(255,255,255,0.8); margin-bottom: 30px;">전문가 무료시공 포함 - 최대 20만원 절약!</p>
                    <a href="sinkbowl.php" style="display: inline-flex; align-items: center; gap: 10px; background: #fff; color: #0284c7; padding: 16px 40px; border-radius: 12px; font-size: 1.1rem; font-weight: 600; text-decoration: none; transition: all 0.3s ease; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                        <span>싱크볼 특가 보러가기</span>
                        <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
            </div>
    ...
    <div class="phone-inquiry-container" id="phoneInquiry">
        ...
        <a href="tel:1661-9038" class="phone-inquiry-float"><img decoding="async" src="/tnwjd/KakaoTalk_20260313_130929757_clean.png" alt="전화문의" width="222" height="202"></a>
    </div>
